...
export const DEFAULT_CONFIG: EvoConfig = {
  ...
  HERMES_GATEWAY_URL:         env('HERMES_GATEWAY_URL',         'http://localhost:18789'),
  HERMES_POLL_INTERVAL_MS:    envInt('HERMES_POLL_INTERVAL_MS',   10000),
  SKILL_OUTPUT_DIR:           env('SKILL_OUTPUT_DIR',            '~/.hermes/skills/'),
  SKILL_TEMPLATE_DIR:       env('SKILL_TEMPLATE_DIR',          './templates/'),
  MEMORY_DIR:                 env('MEMORY_DIR',                  '~/.hermes/evo-memory/'),
